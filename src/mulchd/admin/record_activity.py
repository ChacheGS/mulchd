...
@router.get("/p/{org_slug}/{project_slug}/record-activity")
async def record_activity_page(
    request: Request,
    org_slug: str,
    project_slug: str,
    action: str = "",
...
async def restore_record_action(
    ...
    return RedirectResponse(f"/admin/p/{project}/record-activity", status_code=303)
