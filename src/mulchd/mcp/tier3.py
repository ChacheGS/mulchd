...
tier3_server = Server("mulchd", instructions=SESSION_WORKFLOW)
tier3_manager = StreamableHTTPSessionManager(app=tier3_server, stateless=True)
...
@tier3_server.list_tools()
async def list_tools() -> list[Tool]:
    return TIER3_TOOLS


@tier3_server.call_tool()
