...
async def upgrade(db: BaseDBAsyncClient) -> str:
    return """
        ALTER TABLE "instance_events" DROP CONSTRAINT IF EXISTS "instance_events_project_id_fkey";
        ALTER TABLE "instance_events" ADD CONSTRAINT "instance_events_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "projects" ("id") ON DELETE RESTRICT;"""


async def downgrade(db: BaseDBAsyncClient) -> str:
    return """
        ALTER TABLE "instance_events" DROP CONSTRAINT IF EXISTS "instance_events_project_id_fkey";
        ALTER TABLE "instance_events" ADD CONSTRAINT "instance_events_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "projects" ("id") ON DELETE CASCADE;"""
