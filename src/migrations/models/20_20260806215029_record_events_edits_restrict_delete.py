...
async def upgrade(db: BaseDBAsyncClient) -> str:
    return """
        ...
        ALTER TABLE "record_events" ADD CONSTRAINT "record_events_actor_id_fkey" FOREIGN KEY ("actor_id") REFERENCES "users" ("id") ON DELETE RESTRICT;
        ALTER TABLE "record_edits" DROP CONSTRAINT IF EXISTS "record_edits_actor_id_fkey";
        ALTER TABLE "record_edits" ADD CONSTRAINT "record_edits_actor_id_fkey" FOREIGN KEY ("actor_id") REFERENCES "users" ("id") ON DELETE RESTRICT;"""


async def downgrade(db: BaseDBAsyncClient) -> str:
    return """
        ALTER TABLE "record_edits" DROP CONSTRAINT IF EXISTS "record_edits_actor_id_fkey";
        ALTER TABLE "record_edits" ADD CONSTRAINT "record_edits_actor_id_fkey" FOREIGN KEY ("actor_id") REFERENCES "users" ("id") ON DELETE CASCADE;
        ALTER TABLE "record_events" DROP CONSTRAINT IF EXISTS "record_events_actor_id_fkey";
        ALTER TABLE "record_events" ADD CONSTRAINT "record_events_actor_id_fkey" FOREIGN KEY ("actor_id") REFERENCES "users" ("id") ON DELETE CASCADE;"""
