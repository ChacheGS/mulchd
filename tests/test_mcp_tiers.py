...
def test_tier2_server_has_session_workflow_instructions():
    from mulchd.mcp.tier2 import tier2_server, SESSION_WORKFLOW
...
async def test_resolve_tier2_with_project_token(db):
    from starlette.requests import Request
    from mulchd.main import resolve_mcp_tier
    from mulchd.auth import create_user, create_project_token
    from mulchd.models import Organization, Project, UserMembership, User, Role
